...
class RecursiveParser:
    ...
    def parse(self):
        ...
        resultado = self.parse_ELO()   # ya no exige LPAREN/RPAREN externos
        if self.current_token().type != "EOF":
            raise SyntaxError("Tokens sobrantes al final de la expresión")
        return resultado
    
    ##PARSE QUE OBLIGA PARENTESIS 
    #def parse(self):
       # print("Iniciando análisis sintáctico...")
    ...
    def parse_S(self):
        ...
        return resultado  # podría ser valor numérico o booleano

    # A completar: otras funciones para parse_ELO, parse_EL2, parse_ER, parse_E, etc.
    def parse_ELO(self):
    ...
    def parse_ELO_L(self, inherited):
        ...
        if tok.type == "OR":
            ...
            # Validar que ambos operandos sean relacionales
    ...
    def parse_ER(self):
        ...
        left = self.parse_E()  # Evaluamos una expresión aritmética
    ...
    def parse_ER_L(self, inherited):
        ...
        # ε-producción (no hay comparación)
        elif tok.type in {"RPAREN", "OR", "AND"}:
            print("Regla: ER_L → ε")
            return {
                "valor": inherited["valor"],
                "relacional": False
            }
    ...
    def parse_E_L(self, inherited):
        ...
        elif tok.type in {"RPAREN", "LT", "GT", "EQ", "NEQ", "LE", "GE", "AND", "OR"}:
            print("Regla: E_L → ε")
            return inherited
    ...
    def parse_T_L(self, inherited):
        ...
        elif tok.type in {"ADD", "SUB", "RPAREN", "LT", "GT", "EQ", "NEQ", "LE", "GE", "AND", "OR"}:
            print("Regla: T_L → ε")
            return inherited
    ...
    def parse_P_L(self, inherited):
        ...
        elif tok.type in {"MUL", "DIV", "ADD", "SUB", "RPAREN", "LT", "GT", "EQ", "NEQ", "LE", "GE", "AND", "OR"}:
            print("Regla: P_L → ε")
            return inherited
